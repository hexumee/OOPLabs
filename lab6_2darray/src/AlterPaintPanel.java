...
public class AlterPaintPanel extends JPanel {
    ...
    public AlterPaintPanel() {
        try {
            Scanner sc = new Scanner(new File("dataAlt.txt"));
            width = sc.nextInt();
            height = sc.nextInt();
            array = new int[height][width+10];
    ...
    public void paint(Graphics g) {
        ...
        for (int i = 0; i < height; i++) {
            for (int j = 0; j < width; j++) {
                ...
                g.fillRect(50+40*j, 45+40*i, 40, 40);
                g.setColor(Color.black);
                g.drawRect(50+40*j, 45+40*i, 40, 40);
            }
        }
